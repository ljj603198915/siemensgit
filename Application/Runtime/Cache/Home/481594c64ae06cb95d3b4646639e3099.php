...
<head>
    ...
    <link rel="stylesheet" href="<?php echo HomeCssUrl;?>/joinus.css" />
...
<div class="logo-container">
    ...
    <div class="info-container">
        ...
        <div class="line">
            <span class="label tel">电&nbsp;话</span>
            <input type="text" class="tel">
        </div>
        <div class="line">
            <span class="label">省&nbsp;份</span>
            <select onchange="chinaChange(this,document.getElementById('city'));" name="" id="province" class="province">
        ...
        <div class="line">
            <span class="label">城&nbsp;市</span>
            <select name="" id="city" class="city">
                <option value ="请选择市区">请选择市区</option>
            </select>
            <span class="i-con"><i class="fa fa-caret-down fa-lg"></i></span>
        </div>
        <div class="line agency">
            <span class="label" style="">希&nbsp;望&nbsp;代&nbsp;理&nbsp;的&nbsp;产&nbsp;品</span>
...
<script type="text/javascript" src="<?php echo HomeJsUrl;?>/joinus.js"></script>
</body>
