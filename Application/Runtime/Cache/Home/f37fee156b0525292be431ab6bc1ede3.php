...
<div class="logo-container">
    ...
    <div class="info-container">
        ...
        <div class="line">
            <span class="label name">*姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp&nbsp&nbsp;&nbsp;名</span>
            <input type="text" class="name">
        </div>
        <div class="line">
            <span class="label tel">*联&nbsp系&nbsp电&nbsp话</span>
            <input type="text" class="tel">
        </div>
        <div class="line">
            <span class="label mail">&nbsp电&nbsp子&nbsp邮&nbsp箱</span>
        ...
        <div class="line">
            <span class="label mail">&nbsp上&nbsp传&nbsp图&nbsp片</span>
            <!--dom结构部分-->
            <div id="filePicker" id="uploader-container">
                <!--用来存放item-->
                <div class="webUploader-picker">&nbsp选择图片</div>
            ...
            <div class="line">
                <span class="label com-advices">*投&nbsp诉&nbsp建&nbsp议</span>
