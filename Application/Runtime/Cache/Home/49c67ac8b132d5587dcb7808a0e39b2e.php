...
<head>
    ...
    <link rel="stylesheet" href="<?php echo HomeCssUrl;?>/indexn.css" />
...
<div class="wrapper">
    <div class="item1">
        <a href="http://www.wawechat.siemens.com.cn/index.php/Home/Checkproduct/checkproduct.html">
            <div class="icon"><i class="fa fa-diamond fa-lg"></i></div>
            <div class="text">
                <p class="chi">产品说明书</p>
